    ...
    <Wrapper>
      <Inner>
        ...
        <BannerCtn>
          ...
          >
            {isMobile ? (
              <Image src={medical_mobile_banner} alt="banner_img" fill />
            ) : (
              <Image src={medical_banner} alt="banner_img" fill />
            )}
          </Div>
        </BannerCtn>
        <Edges>
...
export default HealtcareBenefits;
