...
import big_banner from '../../../../public/images/health-monitor.jpg'; 
import featured_mobile_banner from '../../../../public/images/health-monitor.jpg';
      ...
      <Inner>
        ...
        <ParallaxImages>
          <ParallaxText baseVelocity={-4}>
            <Image src={companies_image} alt="companiies" />
          </ParallaxText>
        </ParallaxImages>
      </Inner>
    </Wrapper>
