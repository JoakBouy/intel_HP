...
export const desktopHeaderPhrases = [
  'Elevate Your Health',
  'Journey with IntelHP',
];
export const desktopParagraphPhrase = [
  'IntelHP offers a world of health possibilities. From predictions to alerts,',
  "we've got you covered. Join us and unlock your potential today.",
];

// For mobile
export const mobileParagraphPhrase = [
  'IntelHP offers a world of health possibilities. From',
  "predictions to alerts, we've got you covered.",
